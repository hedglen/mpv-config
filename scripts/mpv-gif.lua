...
local options = {
    dir = (os.getenv("USERPROFILE") or "C:/Users/rjh") .. "/Pictures/mpv-gifs",
    rez = 600,
    fps = 15,
}
...
start_time = -1
end_time = -1
local _temp = os.getenv("TEMP") or os.getenv("TMP") or os.getenv("TMPDIR") or "/tmp"
palette = _temp .. "\\palette.png"
subs = _temp .. "\\subs.srt"
